window.SITE_DATA = {
  ...
  stack: [
    { title: { en: "Languages", pt: "Linguagens" }, items: ["Java", "Python", "TypeScript"] },
    { title: { en: "Frameworks", pt: "Frameworks" }, items: ["Spring Boot", "Angular"] },
    { title: { en: "Cloud & DevOps", pt: "Cloud & DevOps" }, items: ["AWS", "Git", "GitHub Actions"] },
  ...
  projects: [
    {
      ...
      description: {
        en: "REST API and admin UI for pilates studio management. Backend in Spring Boot 3 / Java 21, frontend in Angular 19.",
        pt: "API REST e UI administrativa para gestão de studio de pilates. Backend em Spring Boot 3 / Java 21, frontend em Angular 19."
      },
      chips: ["Java 21", "Spring Boot 3", "Angular 19", "REST"],
      links: [
